...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>  
    <!-- Chỉnh sửa -->
	<div class="modal fade bd-example-modal-lg" id="mnCustomer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h2 class="modal-title font-weight-bold" id="exampleModalLongTitle">Thông tin khách hàng</h2>
                ...
                <div class="model-body pt-5 pb-5">
                    <div class="container">
					<form:form action="/shopping/manage-update-customer?p=${p}" method="post"
						modelAttribute="mnCustomer" class="row"
						enctype="multipart/form-data">
						<div class="col-5">
							<div class="text-center">
								<img src="/image/employee/${mnCustomer.images}"
						...
						<div class="col-7">
							...
							<div class="form-group">
								...
								<form:input type="text" readonly="${mnCustomer.customerID == null ? false : true}" path="customerID"
									class="form-control w-100" />
							</div>
							<div class="form-group">
