...
<form:form action="/shopping/update-customer" method="post" modelAttribute="pfCustomer" class="row"
	enctype="multipart/form-data">
	<div class="col-5">
		<div class="text-center">
			<img src="/image/employee/${pfCustomer.images}"
	...
	<div class="col-7">
		...
		<div class="form-group">
			...
			<form:input type="text" readonly="true" path="customerID" class="form-control w-100" />
		</div>
		<div class="form-group">
